...
procedure TPagamento.SetCodigoCentroCusto(const Value: integer);
begin
  FCodigoCentroCusto := Value;
end;

procedure TPagamento.SetCodigoEntrada(const Value: integer);
begin
...
procedure TPagamento.SetParcela(const Value: string);
begin
  FParcela := Value;
end;
