  ...
  try
     ...
     begin
        ...
        begin
           ...
           begin
             showmessage('Não é possivel faturar orçamentos de clientes diferentes!');
             abort;
           end;
...
begin
  try
    ...
    begin
      ...
      showmessage('Nenhum orçamento disponível para faturar!');
  finally
    srcEntidade.DataSet.filtered := false;
    btnconsultar.Click;
  end;
...
begin
   ...
   begin
      ...
      begin
         ...
         begin
            showmessage('Não é possivel emitir NFe de clientes diferentes!');
            abort;
         end;
         if (CodigoLote <> '') and (CodigoLote <> srcEntidade.DataSet.FieldByName('CodigoLoteRecebimento').asstring) then
         begin
            showmessage('Não é possivel emitir NFe de Lote diferentes!');
            abort;
         end;
         CodigoCliente := srcEntidade.DataSet.FieldByName('CodigoCliente').asstring;
