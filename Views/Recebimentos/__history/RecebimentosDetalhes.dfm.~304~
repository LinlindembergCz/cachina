inherited FormRecebimentoDetalhes: TFormRecebimentoDetalhes
  Caption = 'Recebimento'
  ClientHeight = 617
  ClientWidth = 1252
      ...
      inherited TabSheet1: TTabSheet
        ...
        inherited grdEntidade: TDBGrid
          ...
          Columns = <
            ...
            item
              ...
              Title.Caption = '%TaxaCartao'
              Visible = True
            end
            item
              Expanded = False
              FieldName = 'PercentualTaxaAntecipacao'
              Title.Caption = '%TaxaAntecipacao'
              Visible = True
            end
            item
              Expanded = False
        ...
        inherited pnlSuperior: TPanel
          ...
          inherited grpPesquisa: TGroupBox
            ...
            object edtCodigoPesquisa: TEdit
              Left = 8
              Top = 31
              Width = 86
              Height = 21
